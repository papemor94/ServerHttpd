...
if test -f ${DESTDIR}/home/pcisse200/tools2021/bin/apr-1-config; then
   APR_CONFIG=${DESTDIR}/home/pcisse200/tools2021/bin/apr-1-config
   APU_CONFIG=${DESTDIR}/home/pcisse200/tools2021/bin/apu-1-config
else
...
test -n "/home/pcisse200/tools2021/bin/apu-1-config" && APU_INCLUDEDIR="`${APU_CONFIG} --includedir`"

installbuilddir="/home/pcisse200/tools2021/build"
